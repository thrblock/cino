...
cino.frame.fullscreen=false
cino.frame.fps=60
cino.frame.flexible=false
cino.frame.hidemouse=true
...
cino.layer.maxlayer=128
cino.gl.projectfunction=glOrtho
cino.gl.project.near=0.0
cino.gl.project.far=1.0
cino.gl.project.modelzfactor=0.0
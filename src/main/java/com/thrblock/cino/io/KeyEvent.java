...
/**
 * KeyEvent for both AWT and NEWT
 * @author thrblock
 *
 */
public class KeyEvent {
    ...
    private Object src;
    public KeyEvent(java.awt.event.KeyEvent awtEvent) {
        setKeyCode(awtEvent.getKeyCode());
        setKeyChar(awtEvent.getKeyChar());
        this.src = awtEvent;
    }
    public KeyEvent(com.jogamp.newt.event.KeyEvent newtEvent) {
        setKeyCode(newtEvent.getKeyCode());
        setKeyChar(newtEvent.getKeyChar());
        this.src = newtEvent;
    }

...
public class FontName {
    ...
    public static final String ARIAL_HEBREW_SCHOLAR = "Arial Hebrew Scholar";
    ...
    public static final String LUCIDA_BLACKLETTER = "Lucida Blackletter";
    ...
    public static final String HEITI_SC = "Heiti SC";
    public static final String HEITI_TC = "Heiti TC";

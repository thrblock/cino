...
public class ShaderToy extends CinoComponent {
    ...
    public void init() throws Exception {
        GLShader vex = new GLShader(GL2ES2.GL_VERTEX_SHADER, new File("./shadersV2/demo/Vertex.txt"));
        GLShader frg = new GLShader(GL2ES2.GL_FRAGMENT_SHADER, new File("./shadersV2/demo/Frag_49899.0"));
